$(function() {
    $("#flexSensors").flexigrid(
      ...
      colModel : [
        ...
        {display: 'Type', name : 'type', width : 70, sortable : true, align: 'left', process: procMe},
        {display: 'Group', name : 'group', width : 100, sortable : true, align: 'left', process: procMe},
        {display: 'Controller', name : 'controller', width : 100, sortable : true, align: 'left', process: procMe},
        {display: 'AddrH', name : 'addressH', width : 70, sortable : true, align: 'left', process: procMe},
        {display: 'AddrL', name : 'addressL', width : 70, sortable : true, align: 'left', process: procMe},
        ...
        {display: 'AlarmDelay (sec)', name : 'trigger_delay', width : 100, sortable : true, align: 'left', process: procMe},
        ...
        {display: 'Offset', name : 'offset', width : 70, sortable : true, align: 'left', process: procMe},
        {display: 'Scale', name : 'scale', width : 70, sortable : true, align: 'left', process: procMe},
        {display: 'Interval (ms)', name : 'interval', width : 70, sortable : true, align: 'left',process: procMe},
